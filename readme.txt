...
= 1.2.0 =
* Feature: add button styles
* Migrated theme.json preset references to the new `var:preset|...|...` format where applicable. Improves compatibility with the latest WordPress theme.json schema (6.7+).
