...
<h1 class="wp-block-heading is-style-default" id="page-not-found"><?php esc_html_e('Page Not Found', 'litos');?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('The page you are looking for does not exist, or it has been moved. Please try searching using the form below.', 'litos');?></p>
<!-- /wp:paragraph -->
